...
ProductRouter.post('/create', authMiddleware, upload.array('images', 6), productController.createProduct);
...
ProductRouter.put('/update/:id', authMiddleware, upload.array('images', 6), productController.updateProduct);
